...
search_space_3waves=np.array(search_space_3waves).T
...
def daily_infected_fitness(candidates):
    ...
    for i,c in enumerate(candidates):        
        pred_infetti=generate_global_distribution(c.reshape(-1,4),num_giorni)
...
print('Solution: ')
print(solution.reshape(-1,4))


pred_infetti=generate_global_distribution(solution.reshape(-1,4),num_giorni+30)
